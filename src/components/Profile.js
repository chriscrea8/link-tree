...
function Profile() {
  return (
    <div className="profile">
      <img className="profile_pic" id="profile__img" src="/images/profile.jpg" alt="profile pic" />
      <a href="https://twitter.com/chriscrea8" target="_blank" rel="noreferrer">
        <p id="twitter">Christian Chukwu</p>
      </a>
